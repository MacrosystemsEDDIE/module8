...
for (i in 1:length(forecast_dates)) {
  ...
  fcast <- as.data.frame(fcast)
    ...
    write.csv(fcast, paste0("C:/Users/wwoel/Desktop/module8/data/wq_forecasts/forecast_day", 15-i, "_UC.csv"), row.names = FALSE)
    
    
}

write.csv(data, paste0("C:/Users/wwoel/Desktop/module8/data/wq_forecasts/mock_chl_obs_UC.csv"), row.names = FALSE)
