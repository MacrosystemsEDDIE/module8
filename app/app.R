...
server <- function(input, output, session){
  ...
  shinyjs::onclick("EF_1",  image_selected_path$img <- EF_links$Forecast[1]) #'USA-NPN Pheno Forecast')
  shinyjs::onclick("EF_2",  image_selected_path$img <- EF_links$Forecast[2]) #'Smart & Connected Water Systems')
  shinyjs::onclick("EF_3",  image_selected_path$img <- EF_links$Forecast[3]) #'EcoCast')
  shinyjs::onclick("EF_4",  image_selected_path$img <- EF_links$Forecast[4]) #'Atlantic Sturgeon Risk of Encounter')
  shinyjs::onclick("EF_5",  image_selected_path$img <- EF_links$Forecast[5]) #'Naturecast Phenology Forecasts')
  shinyjs::onclick("EF_6",  image_selected_path$img <- EF_links$Forecast[6]) #'Portal Forecast')
  shinyjs::onclick("EF_7",  image_selected_path$img <- EF_links$Forecast[7]) #'Coral Reef Watch')
  shinyjs::onclick("EF_8",  image_selected_path$img <- EF_links$Forecast[8]) #'GrassCast')
  shinyjs::onclick("EF_9", image_selected_path$img <- EF_links$Forecast[9]) #'Phenology Monitoring at the Morton Aboretum')
