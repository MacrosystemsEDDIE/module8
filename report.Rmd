...
19. `r module_text["activityB_obj5_Q6", 1]`\
\
**Answer:** `r params$a19`\

20. `r module_text["activityB_obj5_Q8", 1]`\
\
**Answer:** `r params$a20`\
...
## **Objective 7: Explore the forecast output and create a customized forecast visualization for your stakeholder**

Below is a data table of forecast output, the same forecast you used to make decisions in Activity B. In this activity, you will explore multiple ways of communicating this same forecast in order to create a customized forecast visualization for your stakeholder. Choose one day and answer the following questions.  


**You have selected:** `r params$forecast_viz_date`\  

23. What is the mean concentration of all the ensembles?\
\
**Answer:** `r params$mean_ens`\

24. What is the minimum concentration of all the ensembles?\
\
**Answer:** `r params$min_ens`\

25. What is the maximum concentration of all the ensembles?\
\
...
*Figure 3. Custom plot made for `r params$aobj6_stakeholder` `r params$aobj6_stakeholder_other`\. `r params$a_title` `r params$a_caption`* 
```{r results='asis', echo=FALSE}
if (!custom_plot_chk) {cat("-->")}
```


## **Objective 8: Examine how different uncertainty visualizations impact your comprehension and decision-making**

Using your completed, customized visualization, answer the follow questions.

26. `r module_text["activityC_obj8_Q1", 1]`\
\
**Answer:** `r params$a26`\

27. `r module_text["activityC_obj8_Q2", 1]`\
\
**Answer:** `r params$a27`\

28. `r module_text["activityC_obj8_Q3", 1]`\
\
**Answer:** `r params$a28`\

29. `r module_text["activityC_obj8_Q4", 1]`\
\
**Answer:** `r params$a29`\

30. `r module_text["activityC_obj8_Q5", 1]`\
\
**Answer:** `r params$a30`\

31. `r module_text["activityC_obj8_Q6", 1]`\
\
**Answer:** `r params$a31`\

32. `r module_text["activityC_obj8_Q7", 1]`\
\
**Answer:** `r params$a32`\
